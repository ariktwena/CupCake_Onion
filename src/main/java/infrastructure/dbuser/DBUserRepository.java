...
public class DBUserRepository implements UserRepository {
    ...
    public ArrayList<User> getAllUsersFromDB() throws DBexception {
        ...
        try (Connection conn = database.getConnection()){
            ...
            String SQL = "SELECT user_id, user_email, user_role, user_credit FROM users "
                    + "WHERE user_active = 1";
            ...
            while ( rs.next() ) {
                ...
                User user = new User( user_id, user_email, user_role, user_credit);
    ...
    public User getUserById(int user_id) throws DBexception {
        ...
        try (Connection conn = database.getConnection()){
            ...
            String SQL = "SELECT user_email, user_role, user_credit FROM users "
                    + "WHERE user_id = ?";
            ...
            if ( rs.next() ) {
                ...
                user = new User( user_id, user_email, user_role, user_credit);
